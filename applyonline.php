...
$state=$tablestudents->insert_14fields($tablename, 'surname', $surname, 'othername', $othername, 'class', $class, 'sex', $sex, 'dateofbirth', $dateofbirth, 'address', $address, 'lga', $lga, 'state', $state, 'country', $country, 'odate', $odate, 'email', $email, 'passport', $passportname, 'username', $username);
$display=$state;
